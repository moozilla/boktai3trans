...
// <ALTER>エンディング</ALTER> <ALTER>暗黒ローン</ALTER>
 <ALTER>Forge</ALTER>   <ALTER>Bike</ALTER>   <ALTER>Crossover</ALTER>
 <ALTER>Energy</ALTER>  <ALTER>Plays</ALTER>  <ALTER>Titles</ALTER>
 <ALTER>Ending</ALTER>  <ALTER>Dark Loans</ALTER>
$E=====213=====
<PROC=0>
<END>
$E=====214=====
...
//「来たな、ソーラーボーイ!!
<LABEL=KID>Afro Man</LABEL>:
"You came, Soolaar Boyyy!
$E=====3059=====
//記憶喪失(きおくそうしつ)にな
//ったんだって?
//とんだ災難(さいなん)だったな
...
//るからな。
//よろしくたのむぜ?」
I'll buy any accessories if
they're weighin' ya down!
I'm all on that!"
$E=====3100=====
<PROC=0>
<END>
...
$E=====3130=====
//1つはこの店で買うという方法
One way is to buy them at
this store,
$E=====3131=====
//もう1つは、敵(てき)モンスタ
//ーをたおして手に入れるという
//方法だ
and the other is to pick
...
//「おお、
//<NAME>におてんこ!!
<LABEL=SMITH>Middle-Aged Man</LABEL>:
"Oh,
<NAME> and Otenko!
$E=====3188=====
//心配しておったぞ?
...
they'll end up breaking
sooner or later.
$E=====3304=====
//じゃが、折(お)れたからといっ
//て、すてたりするんじゃないぞ
//?
But don't just throw them
away when they break, okay?
$E=====3305=====
//太陽鍛冶(たいようかじ)を行え
//ば、元通りのソードに作り直す
//ことも、
Use them with SOLARFORGE and
you can repair them just
like new.
$E=====3306=====
//新しいソードに作り変えること
//も可能(かのう)なんじゃからな
...
//ほうびは、ほかでは手に入らな
//いモノばかりよ」
The reward for getting S
ranks on missions can't be
...
//イスの弁償代(べんしょうだい)
//1000万ソル!!
You still owe me 'bout a
million Soll for breakin'
the Sol de Vice!
$E=====3731=====
//わすれたとは言わせへんで!」
...
<LABEL=SUMIRE></LABEL>Do you really not remember
me?
 <ALTER>Still don't</ALTER>  <ALTER>I remembered</ALTER>
$E=====4001=====
<PROC=0>
<END>
$E=====4002=====
...
//このまえは、みんなをたすけて
//くれたのに・・・
He saved everyone before...
$E=====4057=====
//おにいちゃんをいじめるの?
//わるいこになっちゃったの?
Was he mean to you? Has he
...
//アイテムとソードとアクセサリ
//ーをあずけられるよ
you can store Items, Swords,
and Accessories.
$E=====4062=====
//そうびちゅうだとあずけられな
//いから、ちゅういしてね」
Keep in mind that you can't
store anything you currently
have equipped."
$E=====4063=====
<PROC=0>
<END>
...
//「ぬいぐるみはね、
<LABEL=SUMIRE>Violet</LABEL>:
"Stuffed dolls are used to
decorate the room,
$E=====4068=====
//おへやにかざってあげると、い
//ろいろなこうかをはっきするよ
but they also have a variety
of special effects.
$E=====4069=====
//はなしかけるとこうかをはっき
//するぬいぐるみも、あるからね
You can activate the effect
by talking to a doll,
$E=====4070=====
//でも、ぬいぐるみをかえられる
//のは、1にちに3かいまでだから
//ちゅういしてね」
but I'll only change dolls
...
about any raw food or
chocolate you've stored."
$E=====4078=====
<PROC=0>
<END>
$E=====4079=====
...
//アンジェレッタがおるすばん、
//するからね」
Angeletta will watch over
yours while I'm gone."
$E=====4084=====
<PROC=0>
<END>
$E=====4085=====
...
//「そうこにあずけるいがいにも
<LABEL=SUMIRE>Violet</LABEL>:
"There's a way to keep items
from rotting,
$E=====4089=====
//アイテムをくさらなくするほう
//ほうが、あるんだよ
without storing them in the
Warehouse.
$E=====4090=====
//おにいちゃん、しってる?」
...
//は、それいじょうくさったり、
//とけたりしないんだよ?
The item's condition won't
get any worse while it's
chocolate-covered.
$E=====4098=====
//おにいちゃん、しってた?」
Did you know that?
...
//き、またしてもわれわれを出し
//ぬくとは
continuing the fight in
Istrakan, he outwitted us
again.
$E=====4317=====
//だが、一度は本体を浄化(じょ
//うか)したのだ、
Although, we did purify his
body once,
$E=====4318=====
//やつもまったくの無傷(むきず)
//というわけではあるまい
so he didn't get out of this
completely unharmed.
$E=====4319=====
//これ以上、やつら闇の一族(イ
//モータル)による被害(ひがい)
//を広げるわけにはいかん
Above all else, we cannot
allow the Immortals to cause
more damage.
$E=====4320=====
//<NAME>、
//急いで準備(じゅんび)を整える
...
//強化することができる能力(の
//うりょく)の1つ、カラダは、
one of the abilities you can
strengthen is Vitality,
$E=====4324=====
//おまえのライフの最大値を決定
//する
which affects your maximum
Life.
$E=====4325=====
//敵(てき)モンスターの攻撃(こ
//うげき)をよけるのが苦手なら
...
Prominence or Dark Claw,
$E=====4344=====
//<WEIGHT>Ｂボタン</WEIGHT>でソルフレアもしくは
//ダークファングを行う
and the <WEIGHT>B Button</WEIGHT> for Sol
Flare or Dark Fang.
$E=====4345=====
//ソルフレアでは、タイミング良
//く<WEIGHT>Ｂボタン</WEIGHT>を押(お)すことで、
If Sol Flare or Dark Fang
connect,
$E=====4346=====
//ダークファングでは、<WEIGHT>Ｂボタン</WEIGHT>
//を連打することで、
keep pressing the <WEIGHT>B Button</WEIGHT>
...
//闇の女王(クイーン・オブ・イ
//モータル)、ヘルとの対決の地
it's where you had the
showdown with the Queen of
Immortals, Hel,
$E=====4369=====
//銀河意思(ダーク)の影響下(え
//いきょうか)にあったサバタと
//の対決の地でもあり、
where you had the showdown
with Sabata under Dark's
influence,
$E=====4370=====
//おまえの母、月の巫女(月下美
//人)、マーニとの別れの地でも
//ある暗黒の城(しろ)・・・
and where you bid farewell
to your mother, Moon Beauty
Mani...
$E=====4371=====
//その地をふたたび血でよごさな
//ければならないのか?」
must blood really be spilled
on that soil again?"
$E=====4372=====
<PROC=0>
<END>
...
//敵(てき)のレベルが自分より高
//いようなら、
If the enemy's level is much
higher than yours,
$E=====4376=====
//そいつとの戦いは、さけたほう
//が良いかもしれん
it may be best to avoid a
confrontation.
$E=====4377=====
//レベルを上げた上で、あらため
//て挑戦(ちょうせん)するんだ
Try facing it again once
you've raised your level.
$E=====4378=====
//ソードやアクセサリーなども、
//自分のレベルに見合ったものを
//装備(そうび)すべきだな」
You should also equip swords
...
//たる月の一族がくらした天上の
//楽園、まほろば・・・
the ancestors of Moon Beauty
Mani and the Queen of
Immortals, Hel, lived...
$E=====4383=====
//ヴァナルガンドのような怪物(
//かいぶつ)を封印(ふういん)し
...
//「だれだ!!
<LABEL=PEOPLE2>Man who Recognizes You</LABEL>:
"Who's there!?
$E=====4399=====
//ん・・・
//少年?
...
//相変わらず記憶(きおく)はもど
//らないが・・・
My memories still haven't
returned...
$E=====4407=====
//こうして各地を回り、アイテム
//の買い付けをやっている
I'm wandering around to
different places, selling
items.
$E=====4408=====
//命がけの仕事だが、おれにはち
//ょうどいい・・・
//腕(うで)には自信があるからな
For dangerous missions, I'm
the man for the job.
You can trust my abilities.
$E=====4409=====
//そうだな・・・
Right...
$E=====4410=====
...
around here, I'm selling.
$E=====4411=====
//サン・ミゲルにある道具屋のお
//嬢(じょう)ちゃんにわたしてく
//れれば、
Hand one over to the girl
who runs the Item Shop in
San Miguel,
$E=====4412=====
//お嬢(じょう)ちゃんの方でも、
//自由に仕入れができるようにな
...
from her whenever you want.
$E=====4413=====
//役に立つかどうかは分からんが
//ちょっとめずらしいアクセサリ
//ーもあるぞ」
Don't know if they'll be
useful, but I also have
...
I'll sell you the items and
accessories I found here."
$E=====4419=====
<PROC=0>
<END>
$E=====4420=====
...
//値(ね)のはるものも多いが、
<LABEL=PEOPLE2>???</LABEL>:
"The items I deal in are
expensive,
$E=====4423=====
//使いどころさえまちがえなけれ
//ば、その効果(こうか)は大きい
but if you use them at the
right moment, they'll be
extremely effective.
$E=====4424=====
//値段(ねだん)分の働きをさせて
//やれよ?」
...
//くさらせるんじゃあないぞ?
<LABEL=PEOPLE2>???</LABEL>:
"My items are hard to find.
Don't let them rot, okay?"
$E=====4427=====
//もっとも、生ものでなければ、
//その心配はないがな」
Naturally, if they're not
perishible then you don't
...
//ここにいないんだが・・・
<LABEL=PEOPLE2>???</LABEL>:
"During the day, I leave to
take care of jobs.
$E=====4430=====
//一仕事終えてもどってくると、
//ここに大量のスティックが落ち
//ていることがあるんだ
When I get back, there are
always a bunch of sticks
lying around...
$E=====4431=====
//いったいあれは何なんだ?
what's up with that?
...
//おれに対する何らかのメッセー
//ジなのか・・・
Wonder if it's some sort of
message for me...
$E=====4433=====
//まさか闇の一族(イモータル)か
//らの警告(けいこく)か!?
could it be a warning from
the immortals!?
$E=====4434=====
//ふうむ・・・
Hmmm...
...
//ッドタイプの魔物(モンスター)
//や、
Undead-type monsters like
Ghouls and Mummies,
$E=====4439=====
//クロロホルルンやゴーストのよ
//うなファントムタイプの魔物(
//モンスター)の一部は、
and some Phantom-type
monsters like Kloroforun and
Ghosts,
$E=====4440=====
//太陽の光に弱い
...
//ゆえに、天窓からの光でダメー
//ジをあたえることができるんだ
That means you can damage
them with the rays from a
skylight.
$E=====4442=====
//だが、太陽のない夜間には注意
//しろよ?
...
//ゅ)か・・・
<LABEL=PEOPLE2>???</LABEL>:
"The Ancient Tree, huh...
$E=====4446=====
//かつてこの世紀末世界が生まれ
//るきっかけになったという、
this giant tree somehow made
it through Ragnarok,
$E=====4447=====
//旧世界(きゅうせかい)の大崩壊
//(だいほうかい)、ラグナロク
the Great Collapse that
...
//今もこうして、天と地を結んで
//いるようだな
Thus has it survived to this
very day, linking heaven and
earth.
$E=====4450=====
//こうしてこの大樹(たいじゅ)の
//中にいると、
While I've been inside this
big tree,
$E=====4451=====
//この世界に来て以来感じていた
//違和感(いわかん)がうすらいで
//いく・・・
the melancholy I've felt
...
//ステータス異常(いじょう)にす
//るポイズナーとパープレクサー
the Poisoner and Perplexer
that emit status effect-
inducing pollen,
$E=====4459=====
//クラウド属性(ぞくせい)でなけ
//ればトドメをさせないアイビー
//もやっかいだ
and Ivy, which can only be
destroyed with Cloud-element
attacks.
$E=====4460=====
//十分に注意してくれ」
be plenty careful around
them."
$E=====4461=====
<PROC=0>
<END>
...
//黒物質(ダークマター)に汚染(
//おせん)されている
It's polluted by Dark Matter
released by an Immortal.
$E=====4465=====
//それはこの森にふる雪もおなじ
//だ
The snow that falls in this
...
travel through rain or snow,
$E=====4467=====
//太陽のしずくを用意しておくか
keep a Drop of Sun handy to
avoid losing the ability to
charge energy.
$E=====4468=====
//もし持っているなら、レインコ
//ートを装備(そうび)しておくと
...
monsters dyed completely
red?
$E=====4475=====
//それは多くの犠牲者(ぎせいし
//ゃ)返り血を浴びた凶悪(きょ
//うあく)モンスター、
They're fiendish monsters
that have bathed in the
blood of countless victims,
$E=====4476=====
//ワンテッドモンスターだ
known as Wanted monsters.
$E=====4477=====
//組織(ギルド)でも賞金をかけて
//手配しているようだが、なみの
//エージェントでは歯が立つまい
The Guild has put a price on
their heads, but the average
...
//アイテムの買い付けというのは
//表向きの仕事にすぎない
but my pretext of selling
items isn't actually my real
job.
$E=====4483=====
//各地での魔物(モンスター)の実
//態(じったい)と、
I go on solo missions to
various places,
$E=====4484=====
//その被害(ひがい)を調査(ちょ
//うさ)するための、単独潜入任
//務(たんどくせんにゅうにんむ)
to research the damage
...
//おめぇ、よくここが分かったな
//?
Dude, you must know this
place pretty well.
$E=====4500=====
//それに、こんな魔物(モンスタ
//ー)だらけの場所で何してんだ?
...what're ya doin' in such
a monster-filled place
anyway?
$E=====4501=====
//おいらか?
...me?
...
//この街にいた記憶(きおく)のな
//い男、???(ハテナ)さん
The man in this town with no
memories, ???.
$E=====4630=====
//今ではアイテムの買い付けに各
//地を回っているようだけど、
He's wandering around
various places selling
items,
$E=====4631=====
//もし冒険(ぼうけん)の途中(と
//ちゅう)で出会えたら、
and if you happen to meet
him on your adventure,
$E=====4632=====
//何かめずらしいアイテムを売っ
//てくれるかもしれないね」
he might sell you some rare
items."
$E=====4633=====
<PROC=0>
<END>
...
//ソードにはそれぞれにレベルが
//設定(せってい)されている
Each sword has its own
respective level.
$E=====4733=====
//自分よりレベルの高いソードは
//作り出すことはできても、装備
//(そうび)することはできない
If you make a sword with a
level higher than yours, you
won't be able to equip it.
$E=====4734=====
<PROC=0>
<END>
$E=====4735=====
...
//とても元気そうだ!
//見ていると元気がわいてくる!
It seems really lively!
Looking at it, you feel
energized!
$E=====4948=====
<PROC=0>
<END>
...
//「たおせどもたおせども、ヤツ
//らはあらわれる・・・
"Defeat after defeat, they
just keep coming...
$E=====4989=====
//まあ、のんびり行こうではない
//か、ワトソン君!!」
well, there's no time to
waste, my dear Watson!"
$E=====4990=====
...
$E=====5006=====
//おがんくさまはノリノリだ{note}
Master Oganku is cheerful.{note}
$E=====5007=====
<PROC=0>
<END>
$E=====5008=====
...
//いると、心がとぎすまされてい
//く。良いソードが作れそうだ!
Looking at his cool glasses,
you feel inspired. You could
probably make a good sword!
$E=====5024=====
<PROC=0>
<END>
$E=====5025=====
//カーネルのぬいぐるみだ
A stuffed doll of Colonel.
$E=====5026=====
//硝煙(しょうえん)のにおいがす
//る。見ていると闘志(とうし)が
//わいてくる!
It smells like gunpowder.
Looking at it, your fighting
spirit boils!
$E=====5027=====
<PROC=0>
<END>
...
//黒ひげの三兄弟なのに、ひげが
//ない?
The Blackbeard Brothers
don't have beards?
$E=====5336=====
//わかってねぇなぁ・・・
//アニキたちはスケルトンだぜ?
You just don't get it...
They're skeletons, right?
$E=====5337=====
//スケルトンにひげがあるか?
//ないだろ?
...
//ンドと共に封印(ふういん)され
//た影(かげ)の一族・・・
The Shadow Clan, sealed
along with the Doomsday
Beast Jormungandr...
$E=====5364=====
//そして、月の一族をほろぼした
//といわれる魔(ま)の一族・・・
...
//人形使いはその魔(ま)の一族の
//出身らしい
The Puppeteer hails from
that Demon Clan.
$E=====5366=====
//まあ、オレが仕えるのは黒ひげ
//のアニキたちだけだがな!」
Well, the Blackbeard
Brothers are the only
ones I serve!
$E=====5367=====
<PROC=0>
<END>
...
//われが出すは、懺悔(ざんげ)の
//問い
I have an atonement problem
for you:
$E=====5392=====
//おまえが今までにたおしてきた
//魔物(モンスター)たちの、
Push blocks with the same
weight as the souls of all
the monsters you've defeated
$E=====5393=====
//魂(たましい)と同じ重さの移動
//(いどう)ブロックを、東の小部
//屋の穴に落とせ」
...
//ノの重さが同じになれば、それ
//が正解(せいかい)ってわけだ」
balance out the contents of
the holes in the west and
east rooms."
$E=====5400=====
<PROC=0>
<END>
...
a stone block weighs 3, and
an iron block weighs 5."
$E=====5403=====
<PROC=0>
<END>
$E=====5404=====
...
<LABEL=OTENKO></LABEL>Is the Sun out?"
 <ALTER>It's out</ALTER>  <ALTER>It's not out</ALTER>
$E=====5421=====
<PROC=0>
<END>
$E=====5422=====
...
//その結果になど興味(きょうみ)
//はない
<LABEL=SABATA></LABEL>But I... I don't care what
happens,
$E=====5565=====
//・・・すべてはどう生きるかだ
or how everything else will
survive.
$E=====5566=====
//あらがい、戦い続けること。
//それがおれの・・・
...
<LABEL=SABATA></LABEL>That's my way of living!"
$E=====5569=====
<PROC=0>
<END>
$E=====5570=====
...
//おれにもまだ、やるべきことが
//あったようだ<LOCK=60>」
Looks like there was still
something left for me to
take care of!<LOCK=60>"
$E=====5592=====
<PROC=0>
<END>
$E=====5593=====
...
//これがあいつの本心だとは思え
//んが・・・
to think that's how he
really felt...
$E=====5626=====
//くそっ、このままでは永遠(え
//いえん)にこの地下牢獄(ちかろ
//うごく)からぬけだせない!!
Argh, at this rate we'll
...
warp or a time strip...
$E=====5643=====
//パンの耳ちょろまかしたぐらい
//でこんな目に会うなんて、割に
//合わねーぜ」
but fer just stealin' some
bread crusts, this is way
harsh!"
$E=====5644=====
<PROC=0>
<END>
...
//たとえいたとしても、どうせ死
//んじまうんだ
Even if he was here, he'd be
dead anyway.
$E=====5651=====
//だったらさがすだけムダさ
No point in even lookin' for
him.
$E=====5652=====
//まったく、伝説の戦士の子孫だ
//なんて・・・
Sayin' I was a descendant
of the Legendary Warrior...
$E=====5653=====
//ぬすみの言いわけにしちゃあ、
//話がデカすぎたぜ
Guess my story was too wild
to use as an excuse for
stealin'.
$E=====5654=====
//それにしても・・・
//ハラへったなぁ」
...
//し出すんだ!
<LABEL=OTENKO></LABEL><NAME>, hurry up and
find him!
$E=====5797=====
//伯爵(はくしゃく)をたおし、サ
//バタの居所(いどころ)を聞き出
...
//「よく聞け、<NAME>
<LABEL=NONE>???</LABEL>:
"As your fighting spirit
builds during battle,
$E=====5887=====
//戦いの中、おまえの心が高ぶる
//と、画面左上にあるTRC(トラン
//スゲージ)が増加(ぞうか)する
...
//兄、サバタにたおされたおまえ
//を復活(ふっかつ)させた
it revived you when you were
defeated by your brother
Sabata.
$E=====5990=====
//おまえは暗黒の力によって生き
//長らえたのだ・・・
...
//!!」
<LABEL=HAKUSYAKU></LABEL>Kha ha ha ha ha!"
$E=====5994=====
<PROC=0>
<END>
$E=====5995=====
...
//それは恐怖(きょうふ)だ
<LABEL=HAKUSYAKU></LABEL>You know, what I truly
desire...
is fear.
$E=====6023=====
//死をともなわない戦いに何の意
...
//をつかみ、
Get close to the coffin and
press the <WEIGHT>A Button</WEIGHT> to grab
it.
$E=====6037=====
//そのまま<WEIGHT>{＋}ボタン</WEIGHT>で移動(いど
//う)すれば、棺桶(かんおけ)を
//運ぶことができる
Hold down the <WEIGHT>A Button</WEIGHT> and
use the <WEIGHT>{＋}Control Pad</WEIGHT> to
drag the coffin along.
$E=====6038=====
//封印(ふういん)したとはいって
//も相手は闇の一族(イモータル)
//だ
Remember that there's an
Immortal sealed inside the
coffin.
$E=====6039=====
//棺桶(かんおけ)を運ぶのがおそ
//すぎたり、棺桶(かんおけ)をほ
//ったらかしにしていると、
If you move too slowly or
leave the coffin unattended,
$E=====6040=====
//闇の中心(ボス部屋)へとにげら
//れてしまうぞ
it will try to escape back
to the boss room.
$E=====6041=====
//棺桶(かんおけ)は迅速(じんそ
//く)かつ慎重(しんちょう)に運
...
//ヴァナルガンドの復活(ふっか
//つ)を、
Prevent Vanargand's revival,
$E=====6070=====
//世界の崩壊(ほうかい)を止めた
//ければな!」
if you want to stop the end
of the world!"
$E=====6071=====
<PROC=0>
<END>
...
//これ以上やつの好きにさせるわ
//けにはいかん!
We can't let him do as he
pleases any more!
$E=====6078=====
//一刻(いっこく)も早くサバタを
//さがし出し、
Find Sabata right away,
$E=====6079=====
//ヴァナルガンドの復活(ふっか
//つ)を阻止(そし)するんだ!!」
and prevent Vanargand's
revival!"
$E=====6080=====
<PROC=0>
<END>
...
//いう破壊(はかい)の獣(けもの)
//のことか?
They're talkin' about the
Beast of Destruction that
wrecked the world?
$E=====6084=====
//まさかアイツが・・・
//伝説(でんせつ)の戦士?
...
<LABEL=TRINITY></LABEL>Hah, that's stupid.
$E=====6087=====
//伝説(でんせつ)の戦士なんてい
//るわけがねぇ
...
//レバースイッチは見当たらない
//が、
When you're blocked by a
grate but you can't find a
lever switch,
$E=====6100=====
//どこかに、この鉄格子(てつご
//うし)を開けるための仕掛(しか
...
<LABEL=OTENKO></LABEL>Understand, <NAME>?"
$E=====6103=====
<PROC=0>
<END>
$E=====6104=====
...
//物(きんもつ)だ
<LABEL=OTENKO></LABEL>at any rate, you must be
prepared.
$E=====6111=====
<PROC=0>
<END>
...
<LABEL=OTENKO></LABEL>Stay alert, <NAME>!
$E=====6113=====
//<PROC=1><LOCK=70>太陽と共にあらんことを!」
<PROC=1><LOCK=70>May the Sun be with you!"
$E=====6114=====
...
//は・・・
<LABEL=TRINITY>Trinity</LABEL>:
"What's with this freakin'
huge tree?
$E=====6119=====
//昔母ちゃんが話してくれた太陽
//樹(たいようじゅ)ってやつか?
Is it the Solar Tree that
...
//あの変なヒマワリ、
//見るからにあやしいぜ
Ever since I saw it, that
sunflower has looked
suspicious.
$E=====6127=====
//・・・ん?
....hm?
...
<LABEL=FRES>Hresvelgr</LABEL>:
<PROC=1><LOCK=20>"Hee hee hee hee hee!"
$E=====6151=====
<PROC=0>
<END>
$E=====6152=====
...
//相変わらず悪シュミだな」
<LABEL=HAKUSYAKU>Count</LABEL>:
<PROC=1><LOCK=6>"Hah, you have bad taste as
usual.
$E=====6157=====
//<LABEL=FRES>フレスベルグ</LABEL>
//「ホッグほどじゃあないよ
...
<LABEL=FRES></LABEL><PROC=1><LOCK=20>Kekekekeke!"
$E=====6167=====
<PROC=0>
<END>
$E=====6168=====
...
//風に運ばれて痛い思いをするか
//もしれないね」
but at this rate the wind
might just be his biggest
...
<LABEL=TRINITY></LABEL>Why'd ya save me?"
 <ALTER>We're friends</ALTER>  <ALTER>I dunno</ALTER>
$E=====6207=====
<PROC=0>
<END>
$E=====6208=====
...
//たぜ!」
<LABEL=TRINITY></LABEL>Heh, I got a little carried
away just now!"
$E=====6222=====
//<LABEL=PLAYER><NAME></LABEL>
//「トリニティ・・・」
...
//ー)の雨!?
<LABEL=OTENKO>Master Otenko</LABEL>:
"It's raining Dark Matter!?
his body can't take so much,
$E=====6286=====
//いくら太陽と月の血を受けつぐ
...
//永(なが)きを生き、老いさらば
//えたわたしには、
Long have I lived, and I
have grown weak in my old
age.
$E=====6309=====
//もはや世界を浄化(じょうか)す
//る力はありません
...
//より、新たな力をあたえられた
//とでもいうのか・・・
So this is the new power you
got from the Ancient Tree...
$E=====6356=====
//クッカッカッカッカッ!!＋
Gwahahahaha!＋
$E=====6357=====
...
//ナルガンドの復活(ふっかつ)を
//阻止(そし)できるやもしれん
With this kind of power it
might just be possible to
stop Vanargand's revival.
$E=====6381=====
//あの男、人形使いの野望は、今
//は亡(な)きわが女王(クイーン)
//の意思とはちがう・・・
That ambitious puppeteer's
schemes are against the
wishes of my late Queen...
$E=====6382=====
//いいだろう、<NAME>
Very well, <NAME>.
$E=====6383=====
//サン・ミゲルよりはるか北方の
//地、白き森に向かえ
Head to the White Forest far
to the north of San Miguel.
$E=====6384=====
//そこで兄、サバタに会うがいい
You should meet your brother
there.
$E=====6385=====
//だが覚悟(かくご)しておくこと
//だ
...
//あの伯爵(はくしゃく)をたおし
//ちまうなんて!
You really defeated the
Count!
$E=====6393=====
//それにしてもさっきのすごい力
//といい・・・
Not to mention that huge
power back then...
$E=====6394=====
//この変なヒマワリは何なんだ?」
...
//こと言ってんじゃねぇ!!
<LABEL=TRINITY></LABEL>I may not know anything, but
at least I don't say such
self-important things!
$E=====6409=====
//オイラのいた未来世紀が・・・
//どんなに悲惨(ひさん)な世界な
//のかを!!」
The Future Era I came
from... it's a miserable
world!"
$E=====6410=====
<PROC=0>
<END>
...
//ボクらにできるのは今をせいい
//っぱいに生きること
as for us, what we can do
right now is to try with all
our might to survive.
$E=====6417=====
<PROC=0>
<END>
$E=====6418=====
//<LABEL=PLAYER></LABEL>ただそれだけさ」
<LABEL=PLAYER></LABEL>That's it."
$E=====6419=====
//<LABEL=OTENKO>おてんこさま</LABEL>
//「そうだ・・・
<LABEL=OTENKO>Master Otenko</LABEL>:
...
//白き森、サバタがいるという北
//方の地へ向かおう
Head toward the White Forest
to the north, where Sabata
should be.
$E=====6426=====
//やつに会い、ことの真相をたし
//かめるんだ!」
Meet up with him and you can
...
//・・・
<LABEL=TRINITY>Trinity</LABEL>:
(Right now, try with all our
might to survive...
$E=====6429=====
//そんなことで本当に未来が変わ
//るのか?
will that kinda thing really
change the future?
$E=====6430=====
//分からない・・・
//コイツは本当に伝説の戦士なの
...
//それでも太陽の使者かよ
<LABEL=TRINITY>Trinity</LABEL>:
"I ain't cold, but even so,
as Messenger of the Sun,
$E=====6445=====
//太陽ってのはもっとこう、あっ
//たかいもんだろ?
couldn't you ask the Sun to
...
//かつてその名でわたしをよんで
//くれた、大切な人がいた・・・
<LABEL=KARMIRA></LABEL>Yes,
I was once called that,
by someone precious to me...
$E=====6484=====
//でもそれがだれだったのか、
//今のわたしには思い出せない
but who that person was, I
...
//に破壊(はかい)の獣(けもの)と
//共にある
<LABEL=KARMIRA></LABEL>His soul is already with
the Beast of Destruction.
$E=====6554=====
//今のわたしには何もできない。
//あの人に近づくことさえ・・・
...
<LABEL=KARMIRA></LABEL>To save the world...
will you fight him?"
...
come about according to
Dark's plans.
$E=====6564=====
//それを書きかえることなど、で
//きないのかもしれない・・・
Perhaps destiny can't be
rewritten...
$E=====6565=====
<PROC=0>
<END>
...
<LABEL=KARMIRA></LABEL>But, even so...
$E=====6567=====
//わたしはあの人を・・・
//サバタさまを、信じる!」
I will believe in him...
I will believe in Sabata!"
$E=====6568=====
<PROC=0>
<END>
$E=====6569=====
...
//らの道・・・
<LABEL=KARMIRA></LABEL>But the path you've chosen
is full of thorns...
$E=====6572=====
//あなたとの戦いを望むあの人の
//心は、
His spirit, his desire to
fight with you,
$E=====6573=====
//ヴァナルガンドの破壊(はかい)
//の衝動(しょうどう)と共鳴して
...
<LABEL=SABATA></LABEL><PROC=1><LOCK=40>Ha ha ha ha ha!
$E=====6593=====
<PROC=0>
<END>
$E=====6594=====
//<LABEL=SABATA></LABEL>知らないわけではあるまい?
<LABEL=SABATA></LABEL>You don't know why?
$E=====6595=====
//おれはヴァナルガンドを受けつ
//ぐ者
...
//何を言ってもムダだ
<LABEL=OTENKO></LABEL><NAME>, we can't reason
with Sabata in his current
state.
$E=====6610=====
//やつをたおし、その上で真実を
//たしかめるしかない!
...
//封印(ふういん)にしばられてい
//る
However, Vanargand is still
sealed away for the moment.
$E=====6642=====
//[血と大地によって月がそまる
//時、破壊(はかい)の獣(けもの)
//はとき放たれる]
...
//暗黒少年として育てられたサバ
//タにとって、
Sabata was brought up as the
Dark Boy.
$E=====6665=====
//暗黒物質(ダークマター)はなく
//てはならないもの
He needs that Dark Matter.
$E=====6666=====
//それを浄化(じょうか)してしま
//えば、恐らくサバタは・・・」
...
//結局は闇の一族(イモータル)の
//仲間・・・
<LABEL=TRINITY></LABEL>For all that talk about
brothers 'n family, he was
still with the Immortals...
$E=====6699=====
<PROC=0>
<END>
$U=====6700=====
...
//けいしゃ)、われらが主(あるじ
//)をむかえに来たのですよ」
<LABEL=RATA></LABEL>Vanargand's successor.
We came to pick up our
master."
$E=====6740=====
<PROC=0>
<END>
...
<PROC=1><LOCK=10><LABEL=RATA></LABEL>Heheheheh..."
$E=====6751=====
//<LABEL=OTENKO>おてんこさま</LABEL>
//「待て、ラタトスク!!」
<LABEL=OTENKO>Master Otenko</LABEL>:
...
//はい)する闇の一族(イモータル
//)、
He's definitely the Immortal
who rules over the Future
Era.
$E=====6765=====
//ヴァナルガンドをあやつり、世
//界をメチャクチャにした破壊(
//はかい)の王
He took control of Vanargand
and caused a ton of
destruction...
$E=====6766=====
<PROC=0>
...
//[海賊島(かいぞくじま)の魔砲(
//まほう)を使え]
'Use the magic cannon on
Pirate Island.'
$E=====6786=====
//棺桶(かんおけ)に残されたサ
//バタからのメッセージだ
It's a message from Sabata,
left in the coffin.
$E=====6787=====
//マップにはその場所もしめされ
//ている」
I'll mark the spot on your
map."
$E=====6788=====
//<LABEL=TRINITY>トリニティ</LABEL>
//「マジかよ・・・
...
//ねぇよ!!」
<LABEL=TRINITY></LABEL>There's no way you could win
that fight!"
$E=====6795=====
//<LABEL=OTENKO>おてんこさま</LABEL>
//「そうかも知れん・・・だが、
...
<LABEL=PLAYER></LABEL>for us...
$E=====6805=====
<PROC=0>
<END>
$E=====6806=====
//<LABEL=PLAYER></LABEL>生きるということなんだ!!」
<LABEL=PLAYER></LABEL>that's what it means to
live!"
$E=====6807=====
<PROC=0>
<END>
...
<LABEL=TRINITY></LABEL>"Good timing.
$E=====6830=====
//この壁(かべ)がこわせそうなん
//だが、オイラの鉄パイプじゃラ
//チが明かねぇ
Looks like this wall can be
broken, but my iron pipe
...
//うだな
<LABEL=OTENKO>Master Otenko</LABEL>:
"Looks like you got Pile
Parts.
$E=====6846=====
//それはパイルドライバーのジェ
//ネレーターにも使われている魔
//法機械だ
They're magical devices that
are also used in the Pile
Driver's Solar Generator.
$E=====6847=====
//わたしにそれ以上の知識(ちし
//き)はないが、
...
//ん)だ
<LABEL=SABATA></LABEL>This is like my worst
nightmare.
$E=====6866=====
//おれの中に慈愛(じあい)の心な
//どあるはずもなかろう?
...
//おれの内にある彼女(かのじょ)
//の魂(たましい)だ
Her soul that lies within me
alongside the Dark Matter.
$E=====6870=====
//彼女(かのじょ)の魂(たましい)
//こそが、このおれを月下美人へ
//と押(お)し上げた・・・
It's her soul that's turning
me into a Moon Beauty...
$E=====6871=====
<PROC=0>
<END>
$E=====6872=====
...
//カーミラ・・・
<LABEL=SABATA></LABEL>The Crying Witch I killed,
Carmilla...
$E=====6873=====
//できることなら・・・
//彼女に人として生と死を取りも
...
//サバタの内にねむるはずのカー
//ミラの魂(たましい)・・・
Carmilla's soul should be
sleeping within Sabata...
$E=====6880=====
//・・・それがなぜ、われわれの
//目の前に?」
...why is it here in front
of us?"
$E=====6881=====
<PROC=0>
<END>
...
//先ほど手に入れたパイルパーツ
//だが、
The Pile Parts you got back
there,
$E=====6884=====
//あれはパイルドライバーのジェ
//ネレーターにも使われている魔
//法機械だ
they're magical machines
that operate the Pile
Driver's Solar Generator.
$E=====6885=====
//わたしにそれ以上の知識(ちし
//き)はないが、
...
<LABEL=OTENKO></LABEL>Let's hurry on, <NAME>."
$E=====6923=====
<PROC=0>
<END>
$E=====6924=====
...
//せっかくのお宝(たから)だが、
//オメェにも1つゆずってやるよ
I finally got some treasure,
and I gotta hand one over to
you.
$E=====6936=====
//好きな方を選びな!」
...
//るようじゃあ、トレジャーハン
//ター失格(しっかく)だからな!
If I got caught by the same
trap twice, I couldn't call
myself a treasure hunter!
$E=====6984=====
//見てろよ・・・」
Watch..."
$E=====6985=====
...
//めったやたらに寒かったり暑か
//ったり・・・
first it was cold, then it
was hot...
$E=====6994=====
//なんなんだよこのダンジョンは
//?
what's up with this dungeon?
$E=====6995=====
//オイラを、こんなトコに連れて
//来んじゃねぇよ!!」
Don't bring me to this kind
of place!"
$E=====6996=====
<PROC=0>
<END>
...
//か・・・
<LABEL=OTENKO>Master Otenko</LABEL>:
"So this is Pirate Island...
$E=====7116=====
//サバタの残したメッセージ、
//[海賊島(かいぞくじま)の魔砲(
//まほう)を使え]
Sabata left us the message,
'Use the magic cannon on
Pirate Island.'
$E=====7117=====
//魔砲(まほう)とはいったいなん
...
//魔砲(まほう)があるのはこの先
//の小島か
so the magic cannon is on
that islet up ahead, huh?
$E=====7124=====
//海をわたる必要があるな・・・
...
//らには、船の1隻(せき)くらい
//はあるだろう
well, it's called Pirate
Island, so there must be a
ship around here somewhere.
$E=====7126=====
<PROC=0>
<END>
$E=====7127=====
...
//まずは使えそうな船をさがすん
//だ!!」
<LABEL=OTENKO></LABEL>First off, <NAME>、
find a ship we can use!"
$E=====7128=====
//<LABEL=TRINITY>トリニティ</LABEL>
//「良いね、良いねぇ!!
<LABEL=TRINITY>Trinity</LABEL>:
...
//お宝(たから)のにおいがプンプ
//ンするぜ!」
That's Pirate Island for ya.
The scent of treasure is
everywhere!"
$E=====7130=====
<PROC=0>
<END>
...
//破壊(はかい)の獣(けもの)の後
//継者(こうけいしゃ)として、
Master Sabata had his soul
connected to Vanargand's,
$E=====7140=====
//その魂(たましい)をヴァナルガ
//ンドと共にした・・・
...
//そしてあなたにたおされること
//を・・・」
<LABEL=KARMIRA></LABEL>His struggle not to destroy,
and his loss to you..."
$E=====7145=====
<PROC=0>
<END>
...
//化(じょうか)され、
<LABEL=KARMIRA>Carmilla</LABEL>:
"Purified by the Pile
Driver,
$E=====7147=====
//暗黒物質(ダークマター)を失っ
//たことで、
he lost his Dark Matter,
$E=====7148=====
//サバタさまは人形使いの支配(
//しはい)からのがれ、ヴァナル
//ガンドからも開放された
thereby escaping the
Puppeteer's control and
separating from Vanargand.
$E=====7149=====
<PROC=0>
<END>
$E=====7150=====
//<LABEL=KARMIRA></LABEL>でもそれは・・・
<LABEL=KARMIRA></LABEL>But that...
$E=====7151=====
<PROC=0>
<END>
$E=====7152=====
...
//なかった
<LABEL=KARMIRA></LABEL>that was all according to
Ratatosk's plan.
$E=====7153=====
//人形使い、ラタトスクは・・・
Ratatosk the Puppeteer...
...
//支配(しはい)しきれなかったあ
//の人を自由にするにまかせ、
he allowed you to free
Sabata from his control,
$E=====7155=====
//あえてあなたに浄化(じょうか)
//させることで、半死半生に追い
//こんだ
daring you to purify him,
driving him half to death.
$E=====7156=====
//あの人を、完全なるあやつり人
//形と化すために・・・」
All in order to convert him
into the perfect puppet..."
$E=====7157=====
<PROC=0>
<END>
$E=====7158=====
...
//の)として、運命を共にするこ
//とはできる
at least as the Beast of
Destruction, our fates can
be linked together.
$E=====7163=====
<PROC=0>
<END>
...
<LABEL=TRINITY>Trinity</LABEL>:
<PROC=1><LOCK=10>"Gyaaaaaaaaaaaaahhhh!"
$E=====7208=====
<PROC=0>
<END>
$U=====7209=====
...
<LABEL=RATA></LABEL>I'm counting on you, 'hoggr.
$E=====7236=====
//フレスベルグの二の舞(ま)いは
//ふまないでくださいね」
...
//<PROC=1><LOCK=10>「ぎにゃぁぁぁぁぁぁっ!!」
<LABEL=TRINITY>Trinity</LABEL>:
<PROC=1><LOCK=10>"Gyaaaaaaaaaaaaaaaahhh!"
$E=====7249=====
<PROC=0>
<END>
$E=====7250=====
...
$E=====7251=====
//オマエが太陽少年だな?
you're the Solar Boy, huh?
$E=====7252=====
//ベルグをたおしたそうだな
So you're the one who killed
Hresvelgr.
$E=====7253=====
//焼き鳥にされるとは、喰(く)ら
//うことしか頭にないアイツには
//お似合(にあ)いの最後だ
Roasted chicken... a fitting
end for a guy who was all
stomach and no brains.
$E=====7254=====
//だがこのオレはそうはいかん
But I'm not goin' down like
that.
$E=====7255=====
//オレはイモータル四人衆(よに
//んしゅう)の1人・・・
...
//オメェらがオイラを助けたり、
//サバタを助けようとしてても、
You guys have saved me every
time,
$E=====7266=====
//オイラには信じられなかった
but you couldn't depend on
me when it came to rescuing
Sabata.
$E=====7267=====
//オイラのいた世界には、信頼(
//しんらい)なんてものはなかっ
...
thing... I'm sure I could've
saved mom from dying.
$E=====7269=====
//未来は絶望(ぜつぼう)に包まれ
//ている・・・
//それがオイラの現実だ
...
//イラたちは、闇の一族(イモー
//タル)に目をつけられた
We traveled in search of the
Legendary Warrior, watched
by the Immortals.
$E=====7277=====
//何度もアンデッドにおそわれて
//それでも母ちゃんはあきらめな
//かった
We were attacked by undead
so many times, but mom
never gave up.
$E=====7278=====
//どこに行っても、オイラたちを
//助けてくれる人間なんていなか
//ったけど、
Wherever we went, nobody
would help us,
$E=====7279=====
//それでも母ちゃんはあきらめな
//かった
...
//ら、
<LABEL=R_DJANGO><NAME></LABEL>:
"If you can make your loved
ones smile,
$E=====7284=====
//それ以上の理由なんていらない
that's all the reason you
need.
$E=====7285=====
//みんなの笑顔は・・・
//ボクらの太陽なんだ
...
//が、ニーズホッグをこのままに
//しておくことはできない
I'm worried about Ratatosk's
whereabouts, but we can't
leave Nidhoggr like this.
$E=====7294=====
//まずはこの棺桶(かんおけ)を闇
//の領域(ダンジョン)の外に運び
//出し、
First things first. Carry
that coffin out of the
dungeon,
$E=====7295=====
//太陽の光で浄化(じょうか)する
//んだ
...
//ぞ!!
<LABEL=OTENKO></LABEL>Okay, let's use this to head
to the moon!
$E=====7327=====
<PROC=0>
<END>
...
<LABEL=OTENKO></LABEL>Are you ready, <NAME>?"
 <ALTER>Yes</ALTER>  <ALTER>No</ALTER>
$E=====7329=====
<PROC=0>
<END>
...
//ヴァナルガンドの復活(ふっか
//つ)が近いことだけはたしかだ
but Vanargand's revival is
certainly drawing near.
$E=====7337=====
//われわれに時間はない!
...
//ここはニーズホッグの内部。こ
//のままでは危険(きけん)だ
we're inside Nidhoggr.
It's dangerous like this.
$E=====7353=====
//とにかく出口をさがそう!」
Anyway, find a way out!"
$E=====7354=====
<PROC=0>
<END>
$E=====7355=====
...
//をあやつる闇の一族(イモータ
//ル)か!」
You're the Immortal who's
controlling this iron
dragon!"
$E=====7368=====
//<LABEL=NEEZ>ニーズホッグ</LABEL>
//「まったく、しつこい下等生物
//どもだ・・・
<LABEL=NEEZ>Nidhoggr</LABEL>:
"Jeez, you inferior living
beings are so stubborn...
$E=====7369=====
//殺しても殺しても、どこからか
//わいて来やがる
we kill and we kill, but you
just keep coming.
$E=====7370=====
//この世界には、オマエらのよう
//な害虫はいらないんだよ!!
...
//は、命を持たぬわれら闇の一族
//(イモータル)!
The only fitting inhabitants
for this world are the
unliving Immortals,
$E=====7372=====
//そして、われが作り出す鉄(く
//ろがね)の軍団(ぐんだん)のみ
//!!
and the iron army I have
created!
$E=====7373=====
//破壊(はかい)の獣(けもの)の復
//活(ふっかつ)は、それを実現し
...
has raised... we won't allow
it!
$E=====7377=====
//反生命種、闇の一族(イモータ
//ル)を生み出したのが銀河意思
//(ダーク)であるならば、
Dark may have produced
Immortals, the antithesis of
life,
$E=====7378=====
//太陽を、大地を・・・
//すべての生命種を生み出したの
//もまた、銀河意思(ダーク)!
but the same Dark gave birth
to the Sun, the Earth, and
all living creatures!
$E=====7379=====
//それらすべての存在(そんざい)
//に、優劣(ゆうれつ)などはない!!
No being in this world is
inferior to another!
$E=====7380=====
//親がその存在(そんざい)をうば
//おうというのなら、
Parents may lose their own
existence,
$E=====7381=====
//子はあたえられたその命をもっ
//て、自らの存在(そんざい)を守
//るのみ!!」
but they protect that
existence by passing it on
to their children!"
$E=====7382=====
//<LABEL=NEEZ>ニーズホッグ</LABEL>
//「ゲココココッ!!
...
//「ほう・・・
//なかなかやるな?
<LABEL=NONE>Blue Ghost</LABEL>:
"Oh? Not bad.
$E=====7534=====
//だがジョンアニキの問題は、さ
//らにむずかしいぞ?」
But John's problem is even
harder."
$E=====7535=====
<PROC=0>
<END>
...
//えども、われらが仕えるべきは
//人形使いなどではない
They may be Immortals too,
but we have no obligation to
serve Ratatosk and his ilk.
$E=====7544=====
//太陽少年よ・・・
//サバタさまをたのむぞ?
Solar Boy...
...
//の身で闇の一族(イモータル)に
//立ち向かえはしまい・・・」
That pride allows you to
face the Immortals despite
your frail human body..."
$E=====7552=====
<PROC=0>
<END>
$E=====7553=====
...
//かれはわたくしのあやつり人形
//として、旅立ちました
I made him into my puppet
and sent him on a journey.
$E=====7743=====
//1つ目のカギ、ヴァナルガンド
//への生贄(いけにえ)として、
To serve as the first key,
a living sacrifice to
Vanargand,
$E=====7744=====
//月をその血で、そめるために」
and dye the moon with
blood."
$E=====7745=====
<PROC=0>
<END>
...
//うわけにはいきません
<LABEL=RATA>Ratatosk</LABEL>:
"He wouldn't submit to
becoming a living sacrifice.
$E=====7747=====
//かれの強情(ごうじょう)さには
//苦労しました
His stubbornness caused me a
...
<LABEL=RATA></LABEL>Even with my power,
$E=====7752=====
//絶対存在(エターナル)であるヴ
//ァナルガンドをあやつることな
//ど、できはしない
...
//その大いなる力の前には生者も
//死者もなく、
Before such great power,
all things living and
dead...
$E=====7762=====
//すべてがわたくしにひざまずく
//ことでしょう!
they will all kneel before
me!
$E=====7763=====
//人形使い、いえ・・・
The Puppeteer... no,
...
//の前にね!!」
<LABEL=RATA></LABEL>the Lord of Destruction!"
$E=====7766=====
//<LABEL=OTENKO>おてんこさま</LABEL>
//「そんなことは・・・
<LABEL=OTENKO>Master Otenko</LABEL>:
...
//わけですか・・・
<LABEL=RATA></LABEL>I suppose there is no cure
for stupidity...
$E=====7774=====
//仕方がありません。
//あなた方にも加わっていただき
...
//<LABEL=OTENKO></LABEL>太陽は出ているな?」
// <ALTER>出ている</ALTER>  <ALTER>出ていない</ALTER>
<LABEL=OTENKO></LABEL>The sun's out, right?"
 <ALTER>It's out</ALTER>  <ALTER>It's not out</ALTER>
$E=====7783=====
<PROC=0>
<END>
...
//な・・・!!」
<LABEL=PLAYER></LABEL>I'll avenge you both...!"
$E=====7794=====
<PROC=0>
<END>
$E=====7795=====
...
//の伝説・・・
<LABEL=OTENKO>Master Otenko</LABEL>:
"The Future Era legend that
Trinity told us about...
$E=====7804=====
//伝説の戦士は、ヴァナルガンド
//と戦うことなく死んだという
...
//た今、やつが支配(しはい)する
//未来はないはずだ・・・」
At least now that Ratatosk
is dead, he cannot rule over
the future..."
$E=====7809=====
<PROC=0>
<END>
...
//一歩先の未来でさえ、われわれ
//は知ることができない
We can't even know what will
happen after taking a single
step.
$E=====7815=====
//それでも・・・
Even so...
...
//もの)、ヴァナルガンド
The Beast of Destruction,
Vanargand, sealed by the
Lunar Children.
$E=====7835=====
//その封印(ふういん)をとくため
//の2つのカギ、
The 2 keys needed to break
that seal,
$E=====7836=====
//月の巫女(月下美人)の赤き血と
//皆既月食(かいきげっしょく)に
//よる赤き光・・・
the red blood of a Moon
Beauty and the red light of
a lunar eclipse...
$E=====7837=====
//すべての条件(じょうけん)はそ
//ろってしまったが、
All the conditions are in
place,
$E=====7838=====
//サバタへの呪縛(じゅばく)は取
//りのぞかれたはず
but the spell on Sabata
...
//くしゃく)と、とらわれの母を
//求め、
You challenged father's
enemy, the Count, over that
cursed ground,
$E=====7846=====
//おまえはあの、呪(のろ)われた
//大地にいどんだ
seeking to free your captive
mother.
$E=====7847=====
//闇の一族(イモータル)の敵(て
//き)、
Enemy of the Immortals,
$E=====7848=====
//太陽の血と、太陽銃(ガン・デ
//ル・ソル)の継承者(けいしょう
//しゃ)、太陽少年<NAME>
...
//拡散(かくさん)により、
<LABEL=NONE></LABEL>As the Solar System grew
old, living beings spread
out and dispersed from it.
$E=====7855=====
//銀河系(ぎんがけい)そのものの
//死が早まることをおそれた銀河
//意志(ダーク)は、
Concerned that they would
speed up the death of the
galaxy, Dark intervened,
$E=====7856=====
//反生命種である闇の一族(イモ
//ータル)と、その下僕、アンデ
//ッドの介入(かいにゅう)により
introducing the non-living
Immortals and their
servants, the Undead,
$E=====7857=====
//生命種の進化と、その拡散(か
...
//「おれは・・・
<LABEL=NONE>Phantom Sabata</LABEL>
"Under my false mother, the
Queen of Immortals, Hel,
$E=====7864=====
//いつわりの母である闇の女王(
//クイーン・オブ・イモータル)
//ヘルの下で、
I was raised as the Dark
Boy...
$E=====7865=====
//暗黒銃(ガン・デル・ヘル)の使
//い手として・・・
//暗黒少年として育てられた
I was given the Gun Del Hell
to use,
$E=====7866=====
//おれの身体に宿った暗黒物質(
//ダークマター)・・・
and imbued with Dark
Matter...
$E=====7867=====
//それはおれに暗黒の力をあたえ
//はしたが・・・
...
//吸血変異(アンデッド化)こそし
//なかったがな・・・」
<LABEL=NONE></LABEL>Thanks to my Lunar Child
blood, I won't turn undead,
but..."
$E=====7871=====
<PROC=0>
<END>
...
//うたび、
<LABEL=NONE>Phantom Sabata</LABEL>:
"The more I used Dark
Matter,
$E=====7873=====
//おれの身体と心は闇(やみ)に飲
//みこまれていった・・・
the more my body and mind
became engulfed in
darkness...
$E=====7874=====
//闇の女王(クイーン)にとらわれ
//たその妹、月下美人マーニ
The Queen's captive younger
sister, Moon Beauty Mani,
was my real mother.
$E=====7875=====
//真実の母からおのれの正体を知
//らされてなお、おれはおまえと
//の戦いを止めはしなかった
But even after I learned my
true identity, I didn't stop
fighting with you.
$E=====7876=====
<PROC=0>
<END>
...
//とガルム、そして嘆(なげ)きの
//魔女、カーミラ・・・
The ancient spirits Muspell
and Garmr, and the Crying
Witch, Carmilla...
$E=====7879=====
//すべてを犠牲(ぎせい)にして得
//た力をもってしても、
...
//だがおれが真に戦いたかったの
//は、やつらなどではなかった
But they weren't the ones I
truly wanted to fight.
$E=====7887=====
<PROC=0>
<END>
$E=====7888=====
//<LABEL=NONE></LABEL>太陽の街、サン・ミゲル・・・
<LABEL=NONE></LABEL>The City of the Sun, San
Miguel...
$E=====7889=====
//あの街でおまえと共に戦ったと
//き、
...
//ガンド復活(ふっかつ)のための
//生贄(いけにえ)としてささげ、
He offered me as a living
sacrifice in order to revive
Vanargand,
$E=====7896=====
//その後継者(こうけいしゃ)とす
//ることで、
make me its successor,
$E=====7897=====
//破壊(はかい)の獣(けもの)の持
//つ大いなる力を手に入れようと
//したのだ
and obtain the Beast of
Destruction's immense power.
$E=====7898=====
<PROC=0>
<END>
$E=====7899=====
...
//うどう)に共鳴し、おのれの狂
//気(きょうき)を増大させた
It resonated with his
destructive impulses, and
my madness further grew.
$E=====7901=====
//やつの命ずるまま、おまえをほ
//うむるまでに・・・」
Under his command, I even
went so far as to bury
you..."
$E=====7902=====
<PROC=0>
<END>
...
//だがラタトスクによる支配(
//しはい)と、
But due to Ratatosk's
control,
$E=====7906=====
//ヴァナルガンドとの魂(たまし
//い)の共鳴・・・
my soul was resonating with
Vanargand's...
$E=====7907=====
//それらをたち切るには、おまえ
//の力を借り、
To break them apart, I
borrowed your power,
$E=====7908=====
//おれの身体に宿る暗黒物質(ダ
//ークマター)を浄化(じょうか)
...
to purify the Dark Matter
within me.
$E=====7909=====
//自らの手でほうむったおまえを
//待つなど・・・
I waited for the one who I
buried with my own hands...
$E=====7910=====
//まさにおれは、狂気(きょうき)
//のただ中にいた
...
//そこには確信もまた、あったの
//だ
<LABEL=NONE></LABEL>Even so... I was confident
that I'd meet you there.
$E=====7913=====
//おまえは必ずや復活(ふっかつ)
//を果たし、このおれの前に現れ
//ると・・・」
I was positive you'd be
revived, and appear before
me..."
$E=====7914=====
<PROC=0>
<END>
...
//「あの時、白き森で・・・
<LABEL=NONE>Phantom Sabata</LABEL>:
"That time, in the White
Forest...
$E=====7931=====
//おれは自らを浄化(じょうか)さ
//せるため、おまえにいどんだ
in order to get myself
purified, I challenged you.
$E=====7932=====
//おまえとの戦い、それこそが、
//おれが待ち望んでいた戦いだっ
//た
Our fight was something I
had long awaited.
$E=====7933=====
//そう、おれは・・・
Yes, I'm...
...
<LABEL=NONE></LABEL>DESTROY EVERYTHING...!
$E=====7941=====
//ハカイ!
DESTROY!
$E=====7942=====
...
<LABEL=NONE></LABEL>DESTROYYY, <NAME>!
$E=====7945=====
<PROC=0>
<END>
$E=====7946=====
//<LABEL=NONE></LABEL>フッハッハッハッハッ!!」
<LABEL=NONE></LABEL>HA HA HA HA HA!"
$E=====7947=====
<PROC=0>
<END>
$E=====7948=====
...
//ナルガンドのそれと交わり始め
//ている!?
Sabata's soul has begun to
fuse with Vanargand's!?
$E=====7952=====
//このままでは取り返しのつかな
//いことになってしまう!」
...
//トスクの支配(しはい)というさ
//さえを失ったことで、
<LABEL=KARMIRA></LABEL>Having gotten rid of his
Dark Matter to throw off
Ratatosk's control,
$E=====7961=====
//命を失いつつあったサバタさま
//は、
Master Sabata was losing his
life.
$E=====7962=====
//サバタさまが死ぬことで、月の
//巫女(月下美人)の力が失われる
//ことをおそれた、
Afraid of dying and losing
his Moon Beauty power,
$E=====7963=====
//ヴァナルガンドによって、
he turned to Vanargand,
$E=====7964=====
//生と死をこえたその存在(そん
//ざい)の根源(こんげん)である
...
//ヴァナルガンドそのものに成り
//変わろうとしている・・・
and now he's turning into
Vanargand itself...
$E=====7967=====
//過去の呪縛(じゅばく)にとらわ
//れたあの人の心は、
His mind has again been
...
//(きょうき)にそまろうとしてい
//る・・・
and is clouded by the
madness that Vanargand
causes...
$E=====7969=====
<PROC=0>
<END>
...
<LABEL=KARMIRA></LABEL>Hurry, <NAME>!
$E=====7971=====
//もう、あの人を止められるのは
//あなたしかいない!
...
//あの人を救うことはできない
<LABEL=KARMIRA></LABEL>There's... nothing I can do
to save him anymore.
$E=====7975=====
//あの人に・・・
//安らぎをあたえてあげて」
...
<LABEL=SABATA></LABEL>Ha ha ha ha ha!
$E=====8002=====
<PROC=0>
<END>
$E=====8003=====
//<LABEL=SABATA></LABEL>おれは正気だ!
<LABEL=SABATA></LABEL>This is the real me!
$E=====8004=====
//大崩壊(ラグナロク)・・・
//それこそがわが意思だ!!」
My true intention...
...
//の終わり、大崩壊(ラグナロク)
//の果てにこそある
the end of one world is the
beginning of a new one, just
like with Ragnarok.
$E=====8011=====
//失われた者はもどりはしない
...
//未来を切り開く!!
It's that will...
that opens up the way to the
future!
$E=====8021=====
//失われた命をよみがえらせるこ
//とを新生というのなら・・・
Rebirth, you say?
If you resurrect those who
...
//そんなことをリンゴやマーニが
//・・・
Do you think Ringo and
Mani...
$E=====8024=====
//カーミラが望むとでも思うのか
//!?
Do you think Carmilla would
have wanted that!?
$E=====8025=====
//答えろ、サバタ!!」
Answer me, Sabata!"
...
//破壊(はかい)の獣(けもの)と化
//したこのオレをたおすことが!!
Can you defeat me now that
I've become the Beast of
Destruction!?
$E=====8030=====
//できはしないっ!!!!　
That's impossible!!!
...
//おれたちは今、多くの犠牲(ぎ
//せい)の果てに、ここにいる
We've sacrificed so many in
order to get here.
$E=====8048=====
//血塗(ちぬ)られた道の、その果
//てに立っている
We stand at the end of a
path stained with blood.
$E=====8049=====
//今さら何をおそれる?
...
<PROC=1><LOCK=40>UWAAAAAAAAAAAAAAAHHH!"
$E=====8061=====
<PROC=0>
<END>
$E=====8062=====
...
//ーナル)であるヴァナルガンド
//を・・・」
Did we defeat Vanargand, an
Eternal that surpassed life
and death...?"
$E=====8065=====
<PROC=0>
<END>
...
<LABEL=SABATA></LABEL>Right, Carmilla?"
$E=====8093=====
<PROC=0>
<END>
$E=====8094=====
...
can do to save you after
all?
$E=====8096=====
//犠牲(ぎせい)をはらわずして、
//未来をつかむことはできないの
//か?
Does so much have to be
sacrificed to reach the
future?
$E=====8097=====
//教えてくれ!
//リンゴ、マーニ・・・
...
<LABEL=KARMIRA></LABEL><PROC=1><LOCK=6>Kyaahh!"
$E=====8107=====
<PROC=0>
<END>
$E=====8108=====
...
//ねば、どの道われわれに未来は
//ない!
If we don't defeat Vanargand
here, there won't be a
future anyway!
$E=====8116=====
<PROC=0>
<END>
...
//き上げていく
Your children, your
descendants... go build the
future with that life.
$E=====8122=====
//生きること・・・
//それが今、おまえのすべき戦い
//だ!!」
To live...
that is the battle you must
fight now!"
$E=====8123=====
<PROC=0>
<END>
...
//の星のすべての命を、照らし続
//ける
The Sun will always keep
shining on you and all life
on our star.
$E=====8131=====
//みんながおまえの帰りを待って
//いる・・・
Everyone's waiting for your
return...
$E=====8132=====
//さあ、走れ!!
Now run!
...
//「ありがとう、<NAME>
<LABEL=NONE>Master Otenko</LABEL>:
"Thank you, <NAME>.
$E=====8138=====
//さらば、太陽少年!!」
Farewell, Solar Boy!"
...
$E=====8147=====
//大地と月と、太陽のある限り、
As long as the earth, the
moon, and the Sun exist,
$E=====8148=====
//人がその未来をあきらめないか
//ぎり、
as long as people don't give
up on the future,
$E=====8149=====
//<PROC=1><LOCK=50>明日もまた日は昇(のぼ)る!
<PROC=1><LOCK=50>The Sun will rise tomorrow!
...
//い)の獣(けもの)を内部から石
//化する!
With Carmilla's power, turn
the Beast of Destruction to
stone from within!
$E=====8155=====
//それが・・・
//サバタ自身の願いでもあるはず
...
//よくぞここまで戦いぬいた
<LABEL=SABATA>Sabata</LABEL>:
<PROC=1><LOCK=6>"Heh... you fought to the
very end... well done.
$E=====8162=====
//だがわすれるな、
But don't forget,
...
to my true self, neither
Dark Boy nor Moon Beauty.
$E=====8182=====
<PROC=0>
<END>
$E=====8183=====
//<LABEL=SABATA></LABEL>おれの弱さ・・・
<LABEL=SABATA></LABEL>My weakness...
$E=====8184=====
//それは持って生まれた才能や、
//育てられた環境(かんきょう)に
//あるのではない
wasn't the talent I was born
with, or the environment I
was raised in.
$E=====8185=====
//自分の弱さをみとめることので
//きない心・・・
It was my mind, unable to
recognize my own weakness...
$E=====8186=====
//過去にとらわれ、未来を信じる
//ことのできない心・・・
My mind, obsessed with the
past and not believing in
the future...
$E=====8187=====
<PROC=0>
<END>
...
//の獣(けもの)として永遠のねむ
//りにつく
<LABEL=SABATA></LABEL>So I'll go into eternal
slumber as the Beast of
Destruction.
$E=====8193=====
//だが、もしもいつか目覚めるこ
//とがあれば・・・
But if I happen to wake up,
someday...
$E=====8194=====
//おれは必ず、おれ自身を取りも
//どす!
...
//おまえは行け
<LABEL=SABATA></LABEL>"Alright, Carmilla...
Go on.
$E=====8199=====
//生と死の輪廻(りんね)にしたが
//い、人の魂(たましい)の帰るべ
//きところへ・・・」
You must abide by the cycle
of life and death, and
return to a human soul..."
$E=====8200=====
//<LABEL=KARMIRA>カーミラ</LABEL>
//「いいえ、それはできません」
<LABEL=KARMIRA>Carmilla</LABEL>:
...
//おれにはもう、おまえたちと同
//じ未来を歩むことはできん
I can no longer walk toward
the same future you do.
$E=====8217=====
//だが太陽がそうであるように、
//月もまた・・・いつまでもおま
//えを見守っている
But as long as the Sun and
moon are there, I'll be
watching over you.
$E=====8218=====
//そのことをわすれるな・・・
Don't forget that...
...
//の獣(けもの)として永遠のねむ
//りにつく
And alongside Carmilla, go
into eternal slumber as the
Beast of Destruction.
$E=====8240=====
//だが、もしもいつか目覚めるこ
//とがあれば・・・
...
//た今、世界は崩壊(ほうかい)を
//まぬがれた
Now that Vanargand is turned
to stone, the world has
escaped collapse.
$E=====8253=====
//未来は守られたのだ
...
//戦いはまだ終わらない
<LABEL=OTENKO></LABEL>Though I must leave, your
battle is not over yet.
$E=====8263=====
//あの星に生きるすべての命をほ
//ろぼすこと・・・
To destroy all life on our
star...
$E=====8264=====
//それが銀河宇宙(ぎんがうちゅ
//う)の意思であるならば、
...
to live, you have not been
defeated.
$E=====8267=====
//未来へ命をつなぐこと・・・
To pass life on into the
future...
$E=====8268=====
//それこそが、命持つものにとっ
//ての勝利なのだからな!
For living beings, that is
victory!
$E=====8269=====
//さらばだ、
//太陽少年<NAME>!!
...
<LABEL=OTENKO></LABEL><PROC=1><LOCK=70>May the Sun be with you!"
$E=====8273=====
<PROC=0>
<END>
$E=====8274=====
...
<LABEL=NONE></LABEL>Thank you...
$E=====8279=====
//<PROC=1><LOCK=60>ボクらの太陽!!」
<PROC=1><LOCK=60>Our Sun!"
$E=====8280=====
<PROC=0>
<END>
$E=====8281=====
...
<LABEL=KARMIRA></LABEL>If I don't stay here...
$E=====8289=====
//ヴァナルガンドを石のまま、封
//印(ふういん)しておくことはで
//きません
I can't keep Vanargand
sealed in stone.
$E=====8290=====
//ですがあなたは・・・
But you...
...
//りません
<LABEL=KARMIRA></LABEL>You must not die yet.
$E=====8293=====
//あなたにはまだ、あなたを信じ
//る仲間が・・・大切な家族がい
//るのですから
...
//あなたがあたえてくれたもの、
<LABEL=KARMIRA></LABEL>If I gained one thing from
meeting you...
$E=====8308=====
//それを想うだけで・・・
//わたしは戦える!
...
//ボクらはあきらめない、
//明日を、未来を!
We won't give up, not on
tomorrow and not on the
future!
$E=====8384=====
<PROC=0>
<END>
...
<LABEL=OTENKO>Master Otenko</LABEL>:
"The Legendary Warrior is
praised in the Future Era...
$E=====8389=====
//だがそれは、単に1人の英雄(え
//いゆう)を言うのではない
But that's not a single
warrior they're talking
about.
$E=====8390=====
//太古より闇の一族(イモータル)
//と戦い続けてきた太陽の一族
...
//その血を受けついだリンゴと、
//その息子であるおまえたち兄弟
You two brothers, your
father Ringo who inherited
that blood,
$E=====8392=====
//それをささえる仲間たち
and the friends who support
you.
$E=====8393=====
//そして、
...
//説として未来に語りつがれてい
//くのだ」
All of them combined were
passed down to the future as
the Legendary Warrior."
$E=====8397=====
//<LABEL=NONE>???</LABEL>
//「おいおい、
//そうじゃねぇだろ?
<LABEL=NONE>???</LABEL>:
"Hey, that ain't how it
goes.
$E=====8398=====
//伝説の戦士は実在する・・・
The Legendary Warrior really
exists...
$E=====8399=====
//オマエたちの目の前にな!!」
...
//オイラの母ちゃんはメチャクチ
//ャ強かったんだぜ?
She was defeated by that
jerk, but... she was really
strong, y'see.
$E=====8413=====
//このヘルメットだって、母ちゃ
//んのゲンコツから身を守るため
//にかぶってたんだからな!」
I put on this helmet to
...
<LABEL=OTENKO></LABEL>That's not right!!!!!!"
$E=====8424=====
<PROC=0>
<END>
$E=====8425=====
...
//望んでいるだけじゃあ、明日は
//変わらない
wishes alone won't change
the future.
$E=====8428=====
//未来を変えるのは明日
Tomorrow's changes affect
the future.
$E=====8429=====
//明日を変えるのは今日
Today's changes affect
tomorrow.
$E=====8430=====
//今日できること、1人でできる
//ことは小さくても・・・
The changes one person can
make today are small...
$E=====8431=====
//その積み重ねが明日を変え、
//いつか未来をも変えるんだ
but they add up, and in time
the future changes.
$E=====8432=====
//太陽と暗黒、2つの未来・・・
Sun and Darkness, their
future...
$E=====8433=====
//明日もまた日は昇るのだから、
The Sun will rise tomorrow,
...
<PROC=1><LOCK=5>Uwaaaaaaaaaaaaaahhh!"
$E=====8454=====
<PROC=0>
<END>
$E=====8455=====
...
//士・・・
<LABEL=PLAYER><NAME></LABEL>:
"Trinity mentioned the
Legendary Warrior...
$E=====8492=====
//でもそれはやっぱり、ボクのこ
//となんかじゃない
But that can't be me, can
it?
$E=====8493=====
//太古より闇の一族(イモータル)
//と戦い続けてきた太陽の一族
...
//なに涙(なみだ)流しながら笑っ
//てんだよ?
Why are ya cryin' and
laughin' at the same time?
$E=====8530=====
//気持ち悪りぃヤツだなぁ・・・
You're a weird guy...
$E=====8531=====
...
$E=====8591=====
//サバタ、カーミラ・・・<LOCK=45>
Sabata, Carmilla...<LOCK=45>
$E=====8592=====
//おてんこさま・・・<LOCK=45>
Master Otenko...<LOCK=45>
$E=====8593=====
//みんな行ってしまった<LOCK=45>
They're all gone.<LOCK=45>
$E=====8594=====
//みんなを犠牲(ぎせい)にして
//・・・<LOCK=45>
Everyone was sacrificed...<LOCK=45>
$E=====8595=====
//それでも、ボクは・・・」<LOCK=60>
Even so, I..."<LOCK=60>
$E=====8596=====
...
<LABEL=PLAYER></LABEL>Oh no...<LOCK=30>
$E=====8603=====
//それじゃあみんなは・・・
//いったい何のために!<LOCK=60>
But then everyone...
what was the point!?<LOCK=60>
$E=====8604=====
<PROC=0>
<END>
$E=====8605=====
...
<LABEL=PLAYER></LABEL>This isn't the kind of
...
//背後(はいご)からの攻撃(こう
//げき)は、
you can get in a preemptive
hit,
$E=====8695=====
//敵(てき)モンスターにより多く
//のダメージをあたえることがで
//きるぞ
and it will deal more damage
as well.
$E=====8696=====
<PROC=0>
<END>
...
//押(お)しっぱなしにすれば壁(
//かべ)にはりつくことができる
<LABEL=OTENKO></LABEL>Cling to the wall by holding
the <WEIGHT>{＋}Control Pad</WEIGHT> in the
wall's direction.
$E=====8744=====
...
//それは太陽銃(ガン・デル・ソ
//ル)フレーム、ウィザードだ
That's a solar gun frame,
Wizard.
$E=====8754=====
//太陽銃(ガン・デル・ソル)はフ
//レームをつけかえることで、
By replacing the frame on
the Gun Del Sol,
$E=====8755=====
//攻撃方法(こうげきほうほう)を
//切りかえることができる
you can change the way it
attacks.
$E=====8756=====
//フレームの装備(そうび)は、メ
//ニュー画面の太陽銃(ガン・デ
...
//これは何か仕掛(しか)けを動か
//すためのものだ
these things always operate
some sort of mechanism.
$E=====8816=====
//レバースイッチを入れるには、
//レバーを攻撃(こうげき)すれば
//いい
To throw a lever switch,
...
<LABEL=OTENKO></LABEL>Listen up, <NAME>.
$E=====8823=====
//アンデッド(死者)タイプのモン
//スターは太陽の光を苦手とする
Undead-type monsters hate
sunlight.
$E=====8824=====
//天窓(てんまど)の光の中にさそ
//い出せば、
If you lure them into the
glare of a skylight,
$E=====8825=====
//攻撃(こうげき)することなく、
//ダメージをあたえることができ
//るぞ
you can damage them without
even attacking.
$E=====8826=====
//聴覚(ちょうかく)を持つ敵(て
//き)モンスターをさそい出すに
//は、
To lure over a monster with
good hearing,
$E=====8827=====
//壁(かべ)たたきが有効(ゆうこ
//う)だ
your best bet is to tap on
a wall.
$E=====8828=====
//壁(かべ)にはりついた状態(じ
//ょうたい)で<WEIGHT>Ａボタン</WEIGHT>を押(お)
//せば、
If you press the <WEIGHT>A Button</WEIGHT>
while clinging to a wall,
$E=====8829=====
//壁(かべ)をたたいて物音を立て
//敵(てき)モンスターをさそい出
//すことができる
you can lure over enemy
monsters that hear the
sound.
$E=====8830=====
//重要なテクニックだ。
//今のうちにしっかりマスターし
...
//てんまど)を利用することはで
//きないが・・・
But if the Solar Gauge is
at zero, you can't use
skylights...
$E=====8843=====
//重要なテクニックだ。
//今のうちにしっかりマスターし
...
//太陽スタンドに太陽ダケか
<LABEL=OTENKO>Master Otenko</LABEL>:
"Oh, it's a Solar Station
and some Solar Bamboo.
$E=====8846=====
<PROC=0>
<END>
$E=====8847=====
//<LABEL=OTENKO></LABEL>この太陽スタンドは・・・
<LABEL=OTENKO></LABEL>A Solar Station is a magical
device...
$E=====8848=====
//太陽センサーがキャッチした太
//陽の光を、
that collects sunlight
caught by the Solar Sensor, 
$E=====8849=====
//エナジーとして自動的にためて
//おいてくれる魔法機械だ
...
//スタンドの前で<WEIGHT>Ａボタン</WEIGHT>を押(
//お)しっぱなしにすれば、
If you press the <WEIGHT>A Button</WEIGHT> in
front of a Solar Station,
$E=====8851=====
//エナジーをチャージすることが
//できる
you can charge up your
energy.
$E=====8852=====
//夜間でもチャージすることがで
//きるから、昼間の内にエナジー
//を集めておくといい
You can even charge at
night, so it's best to save
...
<LABEL=OTENKO></LABEL>As for Solar Bamboo...
$E=====8855=====
//成長し、地上に飛び出した太陽
//タケノコだ
it's a fully-grown, sprouted
Solar Bamboo Shoot.
$E=====8856=====
//攻撃(こうげき)を加えることで
//中にいる月光虫をよび出すこと
...
//も、こわれることはないから安
//心してくれ
And don't worry--no matter
how much you attack it, it
won't break.
$E=====8858=====
<PROC=0>
<END>
...
//やみ)の気配だ
<LABEL=OTENKO></LABEL>But what should concern you
is this dark presence.
$E=====8860=====
//闇の一族(イモータル)ほどでは
//ないが・・・
It's not quite that of an
Immortal...
$E=====8861=====
//油断(ゆだん)は禁物(きんもつ)
//だぞ、<NAME>!!」
...
//うとする
When an adventurer
approaches, they latch on
and drain life.
$E=====8883=====
//万が一取りつかれてしまったら
//<WEIGHT>{＋}ボタン</WEIGHT>をすばやく動かして、
//ただちにふりほどくんだ
If they manage to latch on
to you, quickly move the
<WEIGHT>{＋}Control Pad</WEIGHT> to shake them.
$E=====8884=====
<PROC=0>
<END>
$E=====8885=====
...
//いれい)なだけあって、太陽の
//光を苦手とする
<LABEL=OTENKO></LABEL>Being Dark spirits, they are
naturally weak to sunlight.
$E=====8886=====
//グール同様、天窓(てんまど)の
//光でダメージをあたえることも
//できるぞ」
Just like with Ghouls, you
can use skylights to damage
them."
$E=====8887=====
<PROC=0>
<END>
...
//それは太陽銃(ガン・デル・ソ
//ル)レンズ、フレイムだ
That's a solar gun lens,
Flame.
$E=====8890=====
//太陽銃(ガン・デル・ソル)はレ
//ンズをつけかえることで、
By replacing the lens on the
Gun Del Sol,
$E=====8891=====
//攻撃属性(こうげきぞくせい)を
//切りかえることができる
...
//ニュー画面の太陽銃(ガン・デ
//ル・ソル)メニューで行うんだ
To equip a lens, go to the
Solar Gun page on the menu
screen.
$E=====8893=====
//装備(そうび)したレンズは、
To Quick Change your
equipped lens,
$E=====8894=====
//<WEIGHT>SELECTボタン</WEIGHT>を押(お)しながら
...
<WEIGHT>B Button</WEIGHT> while holding
<WEIGHT>SELECT</WEIGHT>.
$E=====8895=====
//自由につけかえることができる
Feel free to swap lenses as
often as you want.
$E=====8896=====
//敵(てき)モンスターには、相手
//の苦手とする属性(ぞくせい)で
...
monster with its elemental
weakness,
$E=====8897=====
//より多くのダメージをあたえる
//ことが可能(かのう)だ
the damage you deal will
greatly increase.
$E=====8898=====
//また、炎(ほのお)の力を宿した
//フレイム属性(ぞくせい)の攻撃
//(こうげき)には、
Also, because the Flame lens
contains the power of fire,
$E=====8899=====
//燭台(しょくだい)に炎(ほのお)
//を点す効果もあるぞ
you can light candlesticks
with it.
$E=====8900=====
//そういえば下のフロアにも1つ
//燭台(しょくだい)があったな」
Now that I think about it,
there was a candlestick on
the floor below..."
$E=====8901=====
<PROC=0>
<END>
...
//毒化の状態異常(じょうたいい
//じょう)を引き起こす
<LABEL=OTENKO></LABEL>It spits venom that causes
Poisoned status.
$E=====8906=====
//毒化は、視界(しかい)がうばわ
//れる非常(ひじょう)に危険(き
...
//かいふく)もするが、
<LABEL=OTENKO></LABEL>It will wear off on its own
after a certain amount of
time,
$E=====8909=====
//毒消しを持っているのなら、早
//めに使った方がいいぞ」
but if you have an Antidote
on hand, you should use it
right away."
$E=====8910=====
<PROC=0>
<END>
...
//アでは、視界(しかい)がせばめ
//られてしまう
<LABEL=OTENKO></LABEL>In dark areas like this,
...
//まど)の光があれば、
<LABEL=OTENKO></LABEL>If there's a candlestick or
a skylight,
$E=====8917=====
//闇(やみ)を追いはらうこともで
//きるのだが・・・」
you can push back the
darkness, but..."
$E=====8918=====
<PROC=0>
<END>
...
//けるには、その扉(とびら)と同
//じ色のカギが必要だ
<LABEL=OTENKO></LABEL>To open a locked door, you
need a key of the same
color.
$E=====8923=====
//<NAME>、
//カギをさがすんだ!」
...
//色の扉(とびら)を開けることが
//できる
You can use a key to open a
door of the same color.
$E=====8927=====
//赤のカギで開けられるのは、赤
//の扉(とびら)だ
For instance, this Red Key
opens red doors.
$E=====8928=====
//扉(とびら)の前で<WEIGHT>Ａボタン</WEIGHT>を押
//(お)せば、カギを使うことがで
//きるぞ」
Press the <WEIGHT>A Button</WEIGHT> in front
of the door to use the key."
$E=====8929=====
<PROC=0>
<END>
$E=====8930=====
...
//ある伯爵(はくしゃく)との接近
//(せっきん)
and your recent proximity to
the Vampire Lord, the Count,
$E=====8933=====
//おさえていたはずのヴァンパイ
//アの血が、目覚めてしまったか
//・・・
...
//スター、スケルトンだ
<LABEL=OTENKO></LABEL>Those are Skeletons,
Material-type monsters.
$E=====8982=====
//特別な武器(ぶき)は持たないが
//何度でもよみがえる再生能力(
//さいせいのうりょく)を持つ
They don't have any special
weapons, but they can
regenerate indefinitely.
$E=====8983=====
//やつの再生(さいせい)をふせぐ
//には、属性攻撃(ぞくせいこう
//げき)でトドメをさすしかない
To prevent a Skeleton from
regenerating, finish it off
...
//は注意しろよ?」
<LABEL=OTENKO></LABEL>Make sure to store up a lot
of energy before you go into
battle."
$E=====8986=====
<PROC=0>
<END>
...
//しばりつける力がある
<LABEL=OTENKO>Master Otenko</LABEL>:
"This Solar Barrier binds
the powers of darkness.
$E=====8992=====
//結界の上に置いておけば、棺桶
//(かんおけ)ににげられることは
//ない
If you drag the coffin on
top of it, the coffin won't
be able to escape.
$E=====8993=====
//この太陽結界をチェックポイン
//トに、
Using Solar Barriers as
checkpoints,
$E=====8994=====
//棺桶(かんおけ)を次の太陽結界
//へ、そして闇の領域(ダンジョ
//ン)の外へと運び出すんだ」
drag the coffin outside of
the dungeon."
$E=====8995=====
<PROC=0>
<END>
...
//<LABEL=OTENKO></LABEL>あれはシング(物)タイプのモン
//スター、クレイゴーレムだ
<LABEL=OTENKO></LABEL>Those are Clay Golems,
Material-type monsters.
$E=====8999=====
//ゴーレムは冒険者(ぼうけんし
//ゃ)を見つけると、
When a Golem spots an
adventurer,
$E=====9000=====
//身体を丸め、転がり攻撃(こう
//げき)をしかけてくる
it rolls into a ball and
attacks by slamming into its
target.
$E=====9001=====
<PROC=0>
<END>
...
//十分に注意してくれ」
<LABEL=OTENKO></LABEL>It's a powerful attack.
Be very careful.
$E=====9003=====
<PROC=0>
<END>
...
//「お次はアイビーか・・・
<LABEL=OTENKO>Master Otenko</LABEL>:
"Looks like Ivy is next...
$E=====9005=====
//アイビーはビースト(獣)タイプ
//のモンスターだ
Ivy is a Beast-type monster.
$E=====9006=====
//いくらたおしても、
No matter how many times you
kill it,
...
unless you attack with its
weakness, the Cloud element.
$E=====9008=====
<PROC=0>
<END>
$E=====9009=====
...
//?」
<LABEL=OTENKO></LABEL>Don't waste your time on
them, okay?
$E=====9010=====
<PROC=0>
<END>
...
//<LABEL=OTENKO></LABEL>ファントム(幻影)タイプのモン
//スター、スライムは、
<LABEL=OTENKO></LABEL>Slimes are Phantom-type
monsters,
$E=====9014=====
//通常(つうじょう)は自らのテリ
//トリーを守っているが、
which usually stand guard
over their own territory,
$E=====9015=====
//ダメージを受けると、分裂(ぶ
//んれつ)して攻撃(こうげき)に
//転じる
but will divide and turn
to attack when damaged.
$E=====9016=====
//スライムの攻撃(こうげき)は、
...
//ステータス異常(いじょう)を引
//引き起こす
they inflict the status
effect that corresponds to
their element.
$E=====9018=====
//くれぐれも注意してくれ
...
//ただし苦手属性(にがてぞくせ
//い)の攻撃(こうげき)でなら、
However, if you attack them
with their weak element,
$E=====9020=====
//分裂(ぶんれつ)させることなく
//ダメージをあたえられるぞ
you can deal damage without
them dividing on you.
$E=====9021=====
<PROC=0>
<END>
$E=====9022=====
...
//性(ぞくせい)
<LABEL=OTENKO></LABEL>Purple Slimes are Cloud
element...
$E=====9023=====
//苦手属性(にがてぞくせい)はア
//ースか・・・」
that means their weakness is
Earth..."
$E=====9024=====
<PROC=0>
<END>
...
//あれはビースト(獣)タイプのモ
//ンスター、センチピード
that's a Centipede, a Beast-
type monster.
$E=====9037=====
//やつへの攻撃(こうげき)は、頭
//部へのみ有効(ゆうこう)だ
They're only vulnerable to
attacks to their heads.
$E=====9038=====
<PROC=0>
<END>
$E=====9039=====
...
//では、ダメージをあたえること
//はできない
<LABEL=OTENKO></LABEL>Their bodies and legs cannot
be damaged.
$E=====9040=====
//注意してくれ」
Aim carefully."
...
//プのモンスター、ビーがひそん
//でいる
Beehives contain Bees, which
are Beast-type monsters.
$E=====9044=====
<PROC=0>
<END>
$E=====9045=====
...
//これは太陽の根とよばれる植物
//だ
these patches of vegetation
are called Solar Roots.
$E=====9053=====
<PROC=0>
<END>
$E=====9054=====
...
//ん)の代わりになってくれるの
//だが・・・」
<LABEL=OTENKO></LABEL>When they grow, they form a
shape like stairs, but..."
$E=====9055=====
<PROC=0>
<END>
$E=====9056=====
...
//ンスター、ハウンドだ
<LABEL=OTENKO></LABEL>That's a Hound, a Beast-type
monster.
$E=====9063=====
//ハウンドは視覚(しかく)と聴覚
//(ちょうかく)以外にも、
Besides vision and hearing,
$E=====9064=====
//嗅覚(きゅうかく)、すなわちに
//おいで侵入者(しんにゅうしゃ)
//を発見する
...
//いからな
<LABEL=OTENKO></LABEL>You can't prevent yourself
from leaving a scent,
$E=====9067=====
//戦いをさけたければ、近づかな
//いように注意しろ」
so if you want to avoid
detection, be careful not to
get too close."
$E=====9068=====
<PROC=0>
<END>
...
//ボマーを使えば、太陽グレネー
//ドの爆発(ばくはつ)によって、
With Bomber you can fire
exploding Solar Grenades,
$E=====9074=====
//複数(ふくすう)の敵(てき)に同
//時にダメージをあたえることが
//できるぞ
...
//またダンジョン内の一部の壁(
//かべ)は、
Also, for some of the walls
in dungeons, 
$E=====9076=====
//爆発(ばくはつ)によって破壊(
//はかい)することが可能(かのう
//)だ
it's possible to destroy
them with explosions.
$E=====9077=====
//その壁(かべ)がこわせるかどう
//かは、
To determine whether a wall
is breakable,
$E=====9078=====
//壁(かべ)をたたいたときの音で
//チェックすることができるぞ
tap it and check the sound
it makes.
$E=====9079=====
//爆発(ばくはつ)による大音響(
//だいおんきょう)は、周りの敵
//(てき)すべてを引きつける
Be careful before you set
off an explosion, though,
$E=====9080=====
//取りあつかいには十分注意して
//くれ」
because the loud sound it
creates will attract nearby
monsters.
$E=====9081=====
<PROC=0>
<END>
...
//ホットドッグだ
<LABEL=OTENKO></LABEL>That's a Hot Dog, a Flame-
element Hound.
$E=====9085=====
//やつが残す炎(ほのお)は、引火
//を引き起こす
The flame trails it leaves
behind can catch you on
fire.
$E=====9086=====
<PROC=0>
<END>
...
//?」
<LABEL=OTENKO></LABEL>Don't be careless when
approaching them, okay?"
$E=====9088=====
<PROC=0>
<END>
$E=====9089=====
...
//属性(ぞくせい)の攻撃(こうげ
//き)には、
Also, because the Frost lens
contains the power of ice,
$E=====9096=====
//燭台(しょくだい)の炎(ほのお)
//や火炎弾(かえんだん)を消す効
//果もあるぞ」
It's good at extinguishing
lit candlesticks and flame
bullets."
$E=====9097=====
<PROC=0>
<END>
...
//アイスドッグだ
<LABEL=OTENKO></LABEL>That's an Ice Dog, a Frost-
element Hound.
$E=====9101=====
//やつが残す氷は、氷結を引き起
//こす
The ice trails it leaves
behind can freeze you.
$E=====9102=====
<PROC=0>
<END>
$E=====9103=====
...
//パイルトラップは使っているか
//?
Have you used the Pile Trap
yet?
$E=====9107=====
//パイルトラップでの攻撃(こう
//げき)に使用するエナジーは太
//陽スタンドのものだ
Pile Trap attacks using
energy from the Solar
Station.
$E=====9108=====
//パイルトラップを有効(ゆうこ
//う)に活用すれば、
If you use Pile Trap
effectively,
$E=====9109=====
//おまえ自身のエナジーを温存(
//おんぞん)できるぞ」
you can conserve your own
energy."
$E=====9110=====
<PROC=0>
<END>
...
//属性(ぞくせい)の攻撃(こうげ
//き)には、
Also, because the Cloud lens
contains the power of wind,
$E=====9118=====
//岩ブロックを破壊(はかい)する
//効果(こうか)もあるぞ」
it's good at destroying
stone blocks."
$E=====9119=====
<PROC=0>
<END>
...
//あれがこの船を操作(そうさ)す
//るための舵輪(だりん)か
that's the helm, used to
control the ship.
$E=====9131=====
//<NAME>、
//<WEIGHT>Ａボタン</WEIGHT>を使って、調べてみる
//んだ」
<NAME>, use the <WEIGHT>A Button</WEIGHT>
to check it out."
$E=====9132=====
<PROC=0>
<END>
...
//たスケルトン、スケルトンフェ
//ンサーだ
<LABEL=OTENKO></LABEL>That's a Skeleton Fencer, a
...
//いせいのうりょく)にも注意し
//ろ」
<LABEL=OTENKO></LABEL>Be aware that they have the
same regenerative ability as
Skeletons."
$E=====9139=====
<PROC=0>
<END>
...
//スケルトン、スケルトンアーチ
//ャーだ
<LABEL=OTENKO></LABEL>That's a Skeleton Archer, a
Skeleton wielding a bow.
$E=====9143=====
//遠距離(えんきょり)からの弓矢
//攻撃(こうげき)を得意とする、
//やっかいな敵(てき)だ
They're dangerous enemies
with long-distance arrow
attacks.
$E=====9144=====
<PROC=0>
<END>
...
//いこうげき)で一気に勝負をつ
//けろ」
<LABEL=OTENKO></LABEL>When fighting them, take
them out with elemental
attacks at once."
$E=====9146=====
<PROC=0>
<END>
...
<LABEL=OTENKO></LABEL>Nothing we can do...
$E=====9152=====
//<NAME>、
//このまま先に進み、別の船をさ
//がすんだ!」
<NAME>,
keep going and find another
ship!"
$E=====9153=====
<PROC=0>
<END>
...
Immortals is left, Ratatosk.
$E=====9160=====
//やつがヴァナルガンドを復活(
//ふっかつ)させ、破壊(はかい)
//の王になるというのなら・・・
He plans to revive Vanargand
and become the Lord of
Destruction...
$E=====9161=====
//何としてでも阻止(そし)しなけ
//ればならない!
we must prevent that at any
cost!
$E=====9162=====
//サバタの安否(あんぴ)も気にか
//かる・・・
...
//もう一度あの船に乗り、魔砲(
//まほう)の小島を目指すんだ!
Get on that boat one more
time, and set sail for the
magic cannon on that islet!
$E=====9165=====
//転移魔砲(てんいまほう)とやら
//でラタトスクを追うぞ!!」
Use the magic cannon to
pursue Ratatosk!"
$E=====9166=====
<PROC=0>
<END>
...
//ともかく船首に向かい、舵輪(
//だりん)を調べてみよう
You know the drill. Head to
the bow and examine the
helm.
$E=====9171=====
//あとはあいつが何もしないこと
//をいのるばかりだ・・・」
Just pray that he doesn't
do anything else..."
$E=====9172=====
<PROC=0>
<END>
...
//が昇降機(エレベーター)になっ
//ているようだ
Looks like this room turns
into an elevator somehow.
$E=====9177=====
<PROC=0>
<END>
$E=====9178=====
...
$E=====9179=====
//ここは地下15階・・・
This is basement floor 15...
$E=====9180=====
//王の間に向かうには、スイッチ
//の封印(ふういん)をとくしかな
//いな」
if we're going to get to the
throne room, we need to find
...
//あの通路の先に闇(やみ)の気配
//を感じるのだが、
I feel a dark presence down
that passage,
$E=====9184=====
//足場がなければ、先には進めな
//いな」
but we can't proceed any
farther without a foothold."
$E=====9185=====
<PROC=0>
<END>
$E=====9186=====
...
//じん)、
<LABEL=OTENKO></LABEL>"It seems we have no other
choice...
$E=====9187=====
//行くしかないか・・・
we'll have to use those 4
Warp Magic Squares.
$E=====9188=====
<PROC=0>
<END>
...
//暗闇(くらやみ)エリアに燭台(
//しょくだい)、マミー、
It's the place with Candles
in dark areas, Mummies,
$E=====9198=====
//そして、よみがえりし血の伯爵
//(はくしゃく)・・・
the resurrected Count of
Groundsoaking Blood...
$E=====9199=====
//トリニティに出会ったのも、あ
//の街だったな」
and it's where we came
across Trinity."
$E=====9200=====
<PROC=0>
<END>
...
//たいようゆか)に太陽風、クレ
//イゴーレム、
It's the place with moving
floors, solar floors and
solar wind, Clay Golems,
$E=====9208=====
//そして死の翼(つばさ)、フレス
//ベルグ・・・
...
//古の大樹(たいじゅ)のあたえて
//くれた大いなる力によって、
Thanks to the great power we
obtained from the Ancient
Tree,
$E=====9210=====
//われわれはトランス(合身)を得
//た」
we gained a Trance ability."
$E=====9211=====
<PROC=0>
<END>
$E=====9212=====
...
//幻影(げんえい)に出会ったのも
//あの森だったな」
We also met the ghost of the
Crying Witch, Carmilla, in
that forest."
$E=====9220=====
<PROC=0>
<END>
...
//ライバーの真ん中にセットする
//んだ!!」
position the coffin in the
center of the Pile Driver!"
$E=====9263=====
<PROC=0>
<END>
//その棺桶(かんおけ)をパイルド
...
//太陽と母なる大地の恩恵(おん
//けい)を受け、
The Generators are blessed
by Father Sun and Mother
Earth,
$E=====9267=====
//太陽エネルギーを増幅(ぞうふ
//く)してくれる
so they can amplify solar
energy.
$E=====9268=====
//闇の一族(イモータル)の浄化(
//じょうか)は、
Set each of the 4 Generators
by shooting them with the
Gun Del Sol.
$E=====9269=====
//このパイルドライバーをもって
//のみ可能なのだ!!」
This Pile Driver is the one
and only way to purify
Immortals!"
$E=====9270=====
<PROC=0>
<END>
...
//太陽センサーに太陽の光を当て
<LABEL=OTENKO>Master Otenko</LABEL>:
"Great! Make sure sunlight's
hitting the solar sensor,
$E=====9279=====
//白く光った紋章(もんしょう)の
//上で<WEIGHT>Ａボタン</WEIGHT>を押(お)せば、パ
//イルドライバーの起動だ!」
then press the <WEIGHT>A Button</WEIGHT> over
the flashing white emblem to
start the Pile Driver!"
$E=====9280=====
<PROC=0>
<END>
...
//を浄化(じょうか)することはで
//きん
Guess you won't be able to
purify the Immortal.
$E=====9283=====
//パイルドライバーの起動には、
//太陽の光が必要だ。太陽の光が
//得られる時間に出直すんだ
The Pile Driver requires
sunlight. You'll have to
try again later.
$E=====9284=====
//他のダンジョンでの特殊任務(
//ミッション)や、
You could attempt missions
in other dungeons,
$E=====9285=====
//サーキットでのバイクアクショ
//ンに挑戦(ちょうせん)してみて
//はどうだ?
or you could try one of the
Bike Action circuits.
$E=====9286=====
//さもなくば、いったん冒険(ぼ
//うけん)を中断(ちゅうだん)し
//太陽が出るのを待つしかない」
Or you could stop your
...
//は太陽の光が必要だ!
The sun!
You must have sunlight to
start the Pile Driver!
$E=====9290=====
//太陽センサーに太陽の光を当て
//るんだ!!」
Make sure sunlight's hitting
the solar sensor!"
$E=====9291=====
<PROC=0>
<END>
...
//ジェネレーターから放射(ほう
//しゃ)される太陽パイルで、
Now to purify the Immortal,
$E=====9294=====
//闇の一族(イモータル)を浄化(
//じょうか)するんだ!
with a Solar Pile from the
Generators!
$E=====9295=====
//太陽センサーがキャッチした太
//陽の光が強ければ強いほど、パ
//イルのパワーも上がるぞ
The Pile will be more
powerful if more sunlight is
hitting the solar sensor.
$E=====9296=====
//だが、闇の一族(イモータル)も
//エクトプラズムを使って抵抗(
//ていこう)する
But the Immortal will use
Ectoplasm to resist it.
$E=====9297=====
//太陽銃(ガン・デル・ソル)でエ
//クトプラズムを撃(う)ち、
You'll have to push it back
into the coffin with
Enchantment attacks.
$E=====9298=====
//棺桶(かんおけ)に押(お)しもど
//すんだ
Get the Immortal's Dark
Gauge down to zero,
$E=====9299=====
//画面右上のENE(暗黒ゲージ)が
//ゼロになれば、浄化完了(じょ
...
//闇の一族(イモータル)がにげる
//ぞ!
The Immortal is running
away!
$E=====9304=====
//急いで棺桶(かんおけ)をパイル
//ドライバーの真ん中にセットし
//直すんだ
Hurry up and return it to
...
//「太陽ぉーーーーーー!!」
<LABEL=OTENKO><LOCK=60>Master Otenko</LABEL>:
"Taiyooooooooooh!"
$E=====9309=====
<PROC=0>
<END>
...
//パイルドライバーからのがれた
//闇の一族(イモータル)は、
When an Immortal escapes
from the Pile Driver,
$E=====9314=====
//闇の領域(ダンジョン)の奥深(
//おくふか)く、闇の中心(ボス部
//屋)へと帰ろうとする
it returns to the depths of
the dungeon, the Boss Room.
$E=====9315=====
//そうなれば、いずれは復活(ふ
//っかつ)してしまう!
Anyway, it's going to end up
regenerating!
$E=====9316=====
//急いでやつを連れもどすんだ!
//走れ、太陽少年!!」
...
//　　<ALTER>　　ゲームの説明　　</ALTER>
     <ALTER>Crossover Battle 2</ALTER>
     <ALTER>Game Instructions </ALTER>
$E=====9748=====
<PROC=0>
<END>
$E=====9749=====
